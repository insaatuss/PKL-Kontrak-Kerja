    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Form Data Karyawan</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3">
                <div class="col-md-12">
                  <label for="inputName5" class="form-label">No.Pers</label>
                ...
                <div class="col-md-6">
                  <label for="inputPassword5" class="form-label">Posisi</label>
